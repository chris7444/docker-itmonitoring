...
class Configuration(object):
    ...
    def _get_tls(self):
        ...
        configuration_file = command.service.confs['ssl'.encode('ascii')]
        ...
        configuration_file = command.service.confs['server'.encode('ascii')]
    ...
    def _read_all_configurations(self):
        ...
        for configuration_stanza in self.command.service.confs['ldap'.encode('ascii')].iter():
    ...
    def _read_configuration(self):
        ...
        if command.domain == 'default':
            ...
            configuration_file = command.service.confs['ldap'.encode('ascii')]
            try:
