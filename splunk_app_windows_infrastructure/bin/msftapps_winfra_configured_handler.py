...
HANDLER_NAME = "msftapps_winfra_configured_handler"
LOG_FILE_NAME = "msftapps_winfra_configured_handler.log"
...
SETUP_CONF_Name = "msftapps_winfra_setup"
APP_CONF_NAME = "app"
...
class ResetApp(admin.MConfigHandler):
    ...
    def handleList(self, confInfo):
        logger.info("list %s" % self.requestedAction)
    ...
    def handleReload(self, confInfo):
        ...
        if configured == current:
            ...
            response, content = splunk.rest.simpleRequest(
                '/apps/local/splunk_app_windows_infrastructure',
